...
Se stai contribuendo con modifiche per bontà d’animo, visita l’articolo e fai clic sul collegamento **Modifica** all’interno che porta al codice sorgente di GitHub dell’articolo. Quindi, usa l’interfaccia utente GitHub per apportare le modifiche. Per ulteriori informazioni, consultate la guida Collaboratore generale [di Adobe](https://docs.adobe.com/help/en/contributor/contributor-guide/introduction.html) Docs.
