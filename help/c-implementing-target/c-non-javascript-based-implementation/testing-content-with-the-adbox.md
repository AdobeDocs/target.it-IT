...
1. Crea l&#39;URL AdBox:
   ...
   * Dove `myClientCode` si trova il codice client della tua azienda. Il codice cliente della tua azienda è tutto minuscolo e non ha caratteri speciali.
   ...
   * Dove `image` si trova il tipo di chiamata. In questo caso è un&#39;immagine.

   * Dove `emailHeroImage123_320x200` si trova il nome dell&#39;adbox.

   * Dove `http%3A%2F%2Fwww%2Eyourcompany%2Ecom%2Fimg%2Flogo%2Egif` si trova il contenuto predefinito della mbox. Questa deve essere un&#39;immagine.
