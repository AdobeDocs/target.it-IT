...
description: Utilizza adobe.target.sendNotifications() per at.js per inviare notifiche al server Edge [!DNL Target] quando viene eseguito il rendering di un'esperienza senza utilizzare applyOffer(s). (at.js.2.1 +)
