---
keywords: implementazione;libreria javascript;js;atjs;decisioni su dispositivi;decisioni su dispositivi;artifact regola
description: Scopri l’artefatto della regola JSON utilizzato dalle decisioni sul dispositivo.
title: Che cosa è l’Artifact della regola JSON in On-Device Decisioning?
feature: at.js
role: Developer
...
# Artefatto della regola decisionale su dispositivo

L&#39;artefatto della regola è una rappresentazione JSON delle attività di decisione sul dispositivo [!DNL Adobe Target]. L’artefatto della regola viene generato da [!DNL Target] e propagato alla rete CDN di Akamai per garantire che sia disponibile un artefatto della regola il più vicino possibile ai visitatori. L’artefatto della regola contiene metadati che garantiscono un’esecuzione e una consegna precise delle attività, consentendo al contempo l’analisi in tempo reale tramite il tracciamento degli eventi.

Questo è un esempio di artefatto di una regola JSON:
