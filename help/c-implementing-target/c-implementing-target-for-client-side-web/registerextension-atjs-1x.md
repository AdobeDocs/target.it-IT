...
description: Utilizzate la funzione registerExtension() per la libreria JavaScript di Adobe Target at.js  per registrare un'estensione specifica. (at.js 1.x)
