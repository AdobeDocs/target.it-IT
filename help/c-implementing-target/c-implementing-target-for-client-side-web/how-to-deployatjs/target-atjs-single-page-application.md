...
description: Scoprite come utilizzare  Adobe Target at.js 2.x per implementare Target per applicazioni per pagina singola (SPA).
title: Posso implementare Target per le applicazioni per pagina singola (SPA)?
