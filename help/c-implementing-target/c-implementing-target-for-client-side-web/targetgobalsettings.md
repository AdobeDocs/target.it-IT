...
description: Utilizza la funzione targetGlobalSettings() per la libreria JavaScript at.js di Adobe Target per sostituire le impostazioni invece di utilizzare l’interfaccia utente di Target o le API REST.
