...
description: Utilizza la funzione adobe.target.getOffers() e le relative opzioni per l’Adobe [!DNL Target] at.js library to fire requests to get multiple [!DNL Target] offerte. (at.js 2.x)
