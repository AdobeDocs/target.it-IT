...
Come illustrato in precedenza, utilizzando mbox.js il contenuto della pagina ha iniziato a caricarsi solo al termine della chiamata [!DNL Target] . Utilizzando at.js, il contenuto della pagina comincia a caricarsi quando viene avviata la richiesta di [!DNL Target], senza attenderne il completamento.
...
Tuttavia, se nella pagina è presente l’API visitatore, [!DNL Target] può comprendere meglio in che modo [!DNL at.js] e [!DNL mbox.js] influenzano il tempo di caricamento delle pagine.
...
at.js è più grande perché effettua molta più analisi DOM rispetto a mbox.js. Questo è necessario perché at.js ottiene dati “grezzi” dalla risposta JSON e deve interpretarli. mbox.js utilizzato `document.write()` e l’analisi è stata eseguita dal browser.
...
at.js attualmente utilizza parti di jQuery e quindi vedi la notifica della licenza MIT nella parte superiore di at.js. jQuery non è esposto e non interferisce con la libreria jQuery che hai già sulla pagina, che potrebbe essere una versione diversa. La rimozione del codice jQuery all’interno di at.js non è supportata.

## at.js supporta Safari e l’attraversamento di più domini impostato su “solo x”? {#section_114EC271A6E045E1B2183B66F1B71285}

No, se l’attraversamento di più domini è impostato su &quot;solo x&quot; e Safari ha i cookie di terze parti disabilitati, sia [!DNL mbox.js] che at.js impostano un cookie disabilitato e non vengono eseguite richieste mbox per quel particolare dominio del client.
...
## È possibile utilizzare il Compositore esperienza visivo nelle applicazioni a pagina singola?[!DNL Target] {#section_459C1BEABD4B4A1AADA6CF4EC7A70DFB}
...
Questi messaggi non sono correlati alla funzionalità [!DNL at.js] . La libreria [!DNL at.js] cerca di segnalare tutto ciò che non si trova nel DOM.
...
at.js non blocca il rendering della pagina. Un utente potrebbe notare alcune aree vuote nella pagina che rappresentano elementi personalizzati da [!DNL Target]. Se il contenuto da applicare non contiene molte risorse remote, come SCRIPT o IMG, il rendering dovrebbe essere eseguito rapidamente.
