...
description: Scoprite come implementare  Adobe Target per il Web lato client utilizzando l'SDK Web Adobe Experience Platform (AEP Web SDK) o la libreria JavaScript di Target at.js.
