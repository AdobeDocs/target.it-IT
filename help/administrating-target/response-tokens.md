...
description: Scopri come utilizzare i token di risposta in Adobe [!DNL Target] generare informazioni specifiche da utilizzare nel debug e nell’integrazione con sistemi di terze parti (ad esempio Clicktale).
