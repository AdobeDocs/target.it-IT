...
Il passo successivo dovrebbe essere configurare gli utenti in Target Standard e Target Premium. For more information, see [User management](/help/administrating-target/c-user-management/user-management.md).