...
# Riquadri di visualizzazione per dispositivi mobili per esperienze reattive{#mobile-viewports-for-responsive-experiences}
...
La funzionalità di anteprima del riquadro di visualizzazione per dispositivi mobili è progettata per siti reattivi. I riquadri di visualizzazione per dispositivi mobili si utilizzano quando il sito è reattivo e gli stessi elementi presenti nella pagina del desktop vengono utilizzati nella versione mobile della pagina in una configurazione diversa. Se disponi di una versione mobile del sito separata con una struttura separata, ad esempio [!DNL m.mysite.com], utilizza un’[Attività multipagina.](../../c-experiences/c-visual-experience-composer/multipage-activity.md#concept_277E096063E14813AC5D8EDFA1D2ED48)
...
Ci sono vari siti web che elencano le misure del riquadro di visualizzazione dei dispositivi più popolari. Ad esempio, consultate [https://viewportsizer.com/devices/](https://viewportsizer.com/devices/) o consultare il sito Web del produttore del dispositivo.
...
## Caso d’uso: targeting per due versioni di iPhone {#task_CC3144BF5BA54034996E1D3DB0BC1A35}
...
1. Crea un’attività con l’esperienza per la quale desideri eseguire il targeting.
