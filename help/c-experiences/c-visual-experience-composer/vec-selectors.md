...
description: 'Un selettore di elementi è un''espressione CSS in grado di identificare uno o più elementi. Scoprite come utilizzare i selettori di elementi in  Adobe Target Visual Experience Composer (VEC). '
title: È possibile utilizzare i selettori di elementi in Visual Experience Composer (VEC)?
