...
description: 'Un selettore di elementi è un’espressione CSS che può identificare uno o più elementi. Scopri come utilizzare i selettori di elementi nell’Adobe  [!DNL Target] Compositore esperienza visivo (VEC). '
...
## Come l’Adobe [!DNL Target] genera un selettore per un elemento {#section_D89D954BCBFB486CA081BE183776A475}
