...
+ Introduzione {#introduction}
   ...
   + [Video di formazione su Adobe Target Standard e Premium](c-intro/target-standard-premium-training-videos.md)
...
+ Implementare Target {#implement-target}
   ...
   + Prima dell’implementazione {#before-implement}
      ...
      + Privacy e sicurezza {#privacy}
         ...
         + [Direttive sulla sicurezza dei contenuti (CSP)](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/content-security-policy.md)
   ...
   + Web lato client: implementare Target {#client-side}
      ...
      + Implementazione di mbox.js {#mbox-implement}
         ...
         + Migrare da mbox.js a at.js {#migrate-mbox}
            ...
            + [Plug-in di at.js](c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/c-target-atjs-implementation/target-atjs-plugins.md)
...
+ Integrare Adobe Target con Experience Cloud {#integrate}
   + Adobe Analytics come origine per la generazione di rapporti per Adobe Target (A4T) {#a4t}
      ...
      + [Creazione di attività](c-integrating-target-with-mac/a4t/campaign-creation.md)
...
+ Attività {#activities}
   ...
   + Test A/B {#abtest}
      ...
      + [Nove insidie frequenti per i test A/B e come evitarle](c-activities/t-test-ab/common-ab-testing-pitfalls.md)
