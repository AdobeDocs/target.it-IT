...
![Selettore App](/help/c-intro/assets/apps.png)
...
Ulteriori informazioni sono disponibili nella pagina [Stato dei sistemi Adobe](https://status.adobe.com/). Per ulteriori informazioni, consulta [Aggiornamenti dello stato del sistema e notifiche proattive](/help/c-intro/assets/notifications.png).
...
![Avatar del profilo](/help/c-intro/assets/change-language.png)
...
![Elenco dei tipi di pubblico](/help/c-intro/assets/audience-list.png)
...
Consulta [Recommendations](/help/c-recommendations/recommendations.md) (Consigli) per informazioni dettagliate su [!UICONTROL Recommendations] in [!DNL Target] e per ulteriori informazioni sull’interfaccia utente di [!UICONTROL Recommendations].

## Amministrazione

Fai clic sulla scheda **[!UICONTROL Amministrazione]** per accedere alle pagine [!UICONTROL Amministrazione].

![Pagine amministrazione](/help/c-intro/assets/administration.png)
...
Per ulteriori informazioni dettagliate sull’interfaccia utente, consulta [Panoramica sull’amministrazione di Target](/help/administrating-target/administrating-target.md).
