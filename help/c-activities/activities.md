...
seo-description: Le attività in Adobe Target consentono di sottoporre a test le progettazioni di pagina e di eseguire il targeting del contenuto per audience specifiche.
...
Ad esempio, potete progettare un&#39;attività che sottopone a test due diverse pagine di destinazione, una con informazioni sulle scarpe estive da donna e un&#39;altra pagina di destinazione che evidenzia un abbigliamento estivo generico. L&#39;attività determina le condizioni che controllano quando ciascuna di queste pagine di destinazione viene visualizzata e le metriche che determinano quale pagina ha più successo. L&#39;attività è configurata per iniziare e terminare quando vengono soddisfatte determinate condizioni, ad esempio tra date specifiche, o per iniziare quando l&#39;attività viene approvata e per terminare quando viene disattivata.
...
|--- |--- |
| Type (Tipo) | Il tipo di attività, ad esempio A/B o MVT. |
...
![Azioni hover elenco attività](/help/c-activities/assets/activities_list_hover.png)
...
## Ordinamento e filtro dell&#39;elenco Attività {#section_41DAD479FFF740E2BB67BF4825955670}
...
### Ordinare per attributo activity
...
![Elenco attività crescente](/help/c-activities/assets/activities_list_ascending.png)

## Suggerimenti e trucchi {#section_F77F30A246A14B538D9363B7F3639F97}
...
Se superate uno qualsiasi di questi limiti, l&#39;attività non può essere salvata.
...
## Attributi importati in Target per attività aggiornate fuori da Target {#section_802B0D174E6A44E1A96F404CA81AAE44}
