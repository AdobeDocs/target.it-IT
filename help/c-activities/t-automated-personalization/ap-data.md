...
description: Scopri quale Adobe di dati [!DNL Target] raccoglie e utilizza per creare gli algoritmi di apprendimento automatico in [!UICONTROL Automated Personalization] (AP) e [!UICONTROL Targeting automatico] (AT) attività.
...
# ![PREMIUM](/help/assets/premium.png) Dati utilizzati da [!DNL Target] algoritmi di apprendimento automatico
...
| Mobile - Device - Model Name | Il nome del modello del dispositivo mobile utilizzato per accedere all’attività. | iPhone XS | MOB_targeting.mobile.modelName |
...
|Nome attributo|Descrizione attributo|Valori di esempio|Nome sistema| | — | — | — | — | |Browser - Day of Week|Il giorno della settimana in cui il visitatore ha effettuato l’accesso all’attività.|Da 0 a 6.<br>(0 = domenica)|ENV_DAY_OF_WEEK_HOUR| |Browser - Hour of Day|L&#39;ora del giorno in cui il visitatore ha effettuato l&#39;accesso all&#39;attività.da |0 a 23<br>(0 = mezzanotte)|ENV_USER_HOUR| |Browser - Hour of Week|L&#39;ora della settimana in cui il visitatore ha effettuato l&#39;accesso all&#39;attività.da |0 a 168<br>(0 = mezzanotte di domenica)|ENV_WeekHour| |Browser - Language Setting|La lingua specificata nel browser del visitatore utilizzato per accedere all’attività.|Inglese<br>Tedesco|ENV_Language| |Browser - Screen Height (px)|L&#39;altezza (in pixel) dello schermo del browser del dispositivo utilizzato per accedere all&#39;attività.|1, 2, 3, ecc.|ENV_browserHeight| |Browser - Screen Width (px)|La larghezza (in pixel) dello schermo del browser del dispositivo utilizzato per accedere all’attività.|1, 2, 3, ecc.|ENV_browserWidth| |Browser - Time of Day|L&#39;ora del giorno del browser in cui il visitatore ha effettuato l&#39;accesso all&#39;attività.|0, 6, 12, 18<br>(0 = notte, 6 = mattina,<br>12 pomeriggio, 18 sera)|ENV_LOCAL_TIME_PERIOD| |Browser - Timezone|Il fuso orario del visitatore durante l&#39;accesso all&#39;attività.|Ora del Pacifico<br>Ora orientale<br>GMT|ENV_BrowserTimezoneOffsetMinutes| |Browser - Type|Il tipo di browser utilizzato dal visitatore per accedere all&#39;attività.|Chrome<br>Firefox<br>Internet Explorer<br>Safari<br>Altro|ENV_Browser| |Browser - Weekday/Weekend|Lo stato lavorativo del giorno in cui il visitatore ha effettuato l&#39;accesso all&#39;attività (fine settimana, ore lavorative o orario libero nei giorni feriali).|Sabato e domenica fine settimana<br>Lunedì-Venerdì dalle 0900 alle 1800 è orario di lavoro<br>Lunedì-Venerdì dopo le 1800 fino alle 0900 è orario libero nei giorni feriali|ENV_USER_HOUR_TYPE| |Browser - Window Height (px)|L&#39;altezza (in pixel) della finestra del browser utilizzato dal visitatore per accedere all&#39;attività.|1, 2, 3, ecc.|ENV_BrowserHeight| |Browser - Window Width (px)|La larghezza (in pixel) della finestra del browser utilizzato dal visitatore per accedere all’attività.|1, 2, 3, ecc.|ENG_BrowserWidth| |Device - Screen Height|L&#39;altezza dello schermo del dispositivo utilizzato dal visitatore per accedere all&#39;attività.|1, 2, 3, ecc.|ENV_SCREEN_HEIGHT| |Device - Screen Width|La larghezza dello schermo del dispositivo utilizzato dal visitatore per accedere all&#39;attività.|1, 2, 3, ecc.|ENV_SCREEN_WIDTH| |Sistema operativo|Il sistema operativo sul dispositivo del visitatore utilizzato per accedere all&#39;attività.Sistema operativo Mac<br>Windows<br>Linux<br>Punto di ricerca<br>Sistema operativo sconosciuto|ENV_OperatingSystem| |Sistema operativo - Versione|Versione del sistema operativo utilizzato dal visitatore per accedere all&#39;attività.|Windows 10<br>Mac OS 10|ENV_OPERATING_SYSTEM_VERSION| |Origini del traffico - URL della pagina di destinazione di riferimento|La prima pagina visualizzata dal visitatore all’accesso al sito.|`https://www.adobe.com/ecloud.html`|ENG_REFERRER|
