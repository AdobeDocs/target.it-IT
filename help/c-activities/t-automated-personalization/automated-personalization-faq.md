...
* In base ai tuoi obiettivi, decidi la ripartizione tra controllo e destinazione prima di iniziare l’attività.
   ...
   * Con l’attività di Personalizzazione automatizzata desideri determinare in che modo l’algoritmo di personalizzazione funziona in generale, oppure eseguire un’ottimizzazione della personalizzazione “sempre attiva” nella pagina? A seconda della risposta a questa domanda, potresti voler ripartire un traffico differentemente tra il controllo e la destinazione.
   * Se intendi testare l’algoritmo, suddividi i visitatori a metà tra l’algoritmo di controllo e quello di destinazione. Questa suddivisione fornisce la stima più accurata dell’incremento.
   * Se il tuo obiettivo è invece quello di creare un’attività “sempre attiva”, inserisci dal 10% al 30% dei visitatori nel controllo affinché ci siano abbastanza dati per consentire agli algoritmi di continuare a imparare nel tempo. In questo caso, considera che la personalizzazione di una proporzione maggiore del traffico va a scapito della precisione nell’incremento rilevato.
