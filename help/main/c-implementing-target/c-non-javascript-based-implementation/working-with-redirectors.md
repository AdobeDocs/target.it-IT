...
description: Scopri come utilizzare i redirector nelle implementazioni e-mail, in modo simile a come utilizzi una mbox nel tuo Adobe [!DNL Target] attività.
...
Per decidere la giusta configurazione, consulta [Implementazioni non basate su JavaScript](https://developer.adobe.com/target/implement/email/){target=_blank}.
...
1. Se esegui il test di destinazioni diverse per un annuncio, crea [offerte di reindirizzamento](/help/main/c-experiences/c-visual-experience-composer/redirect-offer.md#task_9578678D42784F5EB9638F8AC8C911FA) per ogni versione.
1. Creare la campagna.

   Vedi [Implementazioni non basate su JavaScript](https://developer.adobe.com/target/implement/email/){target=_blank} per la configurazione corretta che consente di raggiungere gli obiettivi.
...
>[!NOTE]
>
>Si consiglia di determinare il valore del costo utilizzando **Punteggio per visita** metrica di coinvolgimento.
...
>[!NOTE]
>
>Si consiglia di determinare il valore dei ricavi utilizzando **Punteggio per visita** metrica di coinvolgimento.
