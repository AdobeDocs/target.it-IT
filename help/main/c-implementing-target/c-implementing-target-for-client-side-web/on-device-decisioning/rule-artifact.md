...
title: Cosa fa l’artifact della regola JSON in On-Device Decisioning?
feature: at.js
role: Developer
...
L’artefatto della regola è una rappresentazione JSON del tuo [!DNL Adobe Target] attività decisionali su dispositivi. L’artefatto della regola è generato da [!DNL Target] e propagato alla rete CDN Akamai per garantire che vi sia un artefatto di regole disponibile il più vicino possibile ai visitatori. L’artefatto della regola contiene metadati che garantiscono un’esecuzione e una consegna precise delle attività, consentendo al contempo l’analisi in tempo reale tramite il tracciamento degli eventi.
