...
>[!NOTE]
>
>Consulta la [Documentazione API di consegna](https://developer.adobe.com/target/before-administer/){target=_blank} per informazioni sui tipi accettabili per tutti i campi elencati di seguito.
