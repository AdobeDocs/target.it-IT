...
description: Inserire dati in [!DNL Target] utilizzo dell’API di aggiornamento collettivo dei profili.
title: Come inserire i dati in [!DNL Target] Utilizzo dell’API di aggiornamento del profilo bulk?
...
Tramite API, invia un file .csv a [!DNL Adobe Target] con gli aggiornamenti del profilo visitatore per molti visitatori. Ogni profilo visitatore può essere aggiornato con più attributi di profilo nella pagina in una chiamata.
