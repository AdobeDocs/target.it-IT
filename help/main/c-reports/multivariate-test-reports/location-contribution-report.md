...
description: Scopri come utilizzare il rapporto Contributo posizione per le attività Adobe [!DNL Target] [!UICONTROL Targeting esperienza] che mostrano le prestazioni di ogni elemento e di ogni offerta.
title: Come si utilizza il report [!UICONTROL Contributo posizione] per [!UICONTROL attività Test multivariato]?
feature: Reports
...
Il rapporto [!UICONTROL Contributo posizione] mostra le prestazioni di ogni elemento e di ogni offerta.
...
>[!NOTE]
>
>Tieni presente le seguenti informazioni mentre lavori con il rapporto [!UICONTROL Contributo posizione]:
>
...
>
>* I dati per il report [!UICONTROL Contributo posizione] vengono recuperati dal backend [!DNL Target] anche se l&#39;attività è configurata per utilizzare [!UICONTROL Analytics come origine per la generazione di rapporti] (A4T).
>
>* I dati per il report [!UICONTROL Contributo posizione] vengono recuperati per l&#39;ambiente &quot;Produzione&quot; anche se a livello di account [!DNL Target] è definito un ambiente predefinito diverso.

Il report [!UICONTROL Contributo posizione] include due tabelle.
