...
* [Attivare i tipi di pubblico per destinazioni di personalizzazione Edge](https://experienceleague.adobe.com/docs/experience-platform/destinations/ui/activate/activate-edge-personalization-destinations.html){target=_blank} nella guida *Panoramica sulle destinazioni*.
