...
Tutte le metriche [!DNL Analytics], comprese quelle calcolate, sono disponibili in [!DNL Target] e nel report [!UICONTROL Attività Target] in [!DNL Analytics], con una eccezione. Le metriche calcolate per [!UICONTROL Incremento e affidabilità] non sono supportate. Allo stesso modo, qualsiasi segmento disponibile in [!DNL Analytics] può essere applicato a entrambe le soluzioni. Puoi applicare la metrica o il pubblico al rapporto in [!DNL Target] dopo che l’attività è iniziata o anche dopo che è stata completata.
...
* I rapporti di un’attività A4T visualizzati nell’interfaccia utente di [!DNL Target] contengono i dati di [!DNL Analytics]. Ad esempio, se utilizzi la metrica [!UICONTROL Visitatore] in [!DNL Target], stai utilizzando la metrica [!DNL Analytics] [!UICONTROL Visitatore], non la metrica [!DNL Target] [!UICONTROL Visitatori], che ora è chiamata [!UICONTROL Partecipanti]. Questa differenza è particolarmente importante per le metriche relative al traffico di base ([!UICONTROL Visitatori], [!UICONTROL Visite], [!UICONTROL Visualizzazioni pagina]) e per le metriche di conversione.
...
| [Test multivariato (MVT)](/help/main/c-activities/c-multivariate-testing/multivariate-testing.md) | Sì | Richiede metriche di obiettivo basate su mbox per ottenere il rapporto sul [!UICONTROL contributo elemento]. Il report [!UICONTROL Contributo elemento] non supporta attualmente le metriche [!DNL Analytics]. |
...
Per visualizzare i report A4T in [!DNL Target], fai clic su **[!UICONTROL Attività]**, fai clic sull&#39;attività desiderata dall&#39;elenco che utilizza [!DNL Analytics] come origine per la generazione di rapporti, quindi fai clic sulla scheda **[!UICONTROL Rapporti]**.

>[!NOTE]
>
>È possibile utilizzare l&#39;elenco a discesa [!UICONTROL Reporting Source] nella parte superiore della pagina [!UICONTROL Attività] per visualizzare solo le attività che utilizzano A4T.

Per passare dalla [!UICONTROL Vista tabella] alla [!UICONTROL Vista grafico] del report, fai clic sull&#39;icona appropriata in alto a destra nel report.

La figura seguente mostra la [!UICONTROL Vista grafico] di un report A4T con l&#39;elenco a discesa [!UICONTROL Metrica rapporto] contenente le metriche obiettivo [!DNL Analytics] disponibili:

![immagine a4t_report_graph1](assets/a4t_report_graph1.png)

La figura seguente mostra la [!UICONTROL Vista grafico] di un report A4T con l&#39;elenco a discesa [!UICONTROL Pubblico] contenente i tipi di pubblico [!DNL Analytics] disponibili:
...
Per visualizzare il report in [!DNL Analytics] anziché in [!DNL Target], fare clic su **[!UICONTROL Visualizza in Analytics]** nella parte superiore del report.
