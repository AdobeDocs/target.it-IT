...
## Posso visualizzare la mia [!DNL Target] dati di attività in Analysis Workspace? {#workspace}
...
Per informazioni ed esempi dettagliati, apri la [Analytics e Target: Esercitazione sulle best practice per l’analisi](https://spark.adobe.com/page/Lo3Spm4oBOvwF/), fornito da Adobe Experience League.
...
## Perché [!DNL Target] metriche inviate ad Analytics anche dopo la disattivazione dell’attività? {#section_38AA8380A4D54A18972F1EF3E73E22EF}
...
È possibile ridurre la quantità di tempo [!DNL Target] persiste fino a una sessione; tuttavia, ciò è problematico per i test in cui è improbabile che l’evento di conversione si verifichi entro la stessa sessione.
