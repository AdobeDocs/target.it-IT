...
1. In [!DNL Adobe Journey Optimizer], fai clic su **Campagne** nella barra a sinistra per visualizzare la pagina [!UICONTROL Campagne].
...
1. Per aggiungere un elemento nascosto, fare clic su **[!UICONTROL Modifica pagina Web]** nella barra a destra.

1. Fai clic sull&#39;elemento che desideri nascondere, quindi fai clic sul pulsante [!UICONTROL Nascondi] nella barra a destra.
...
>[Creare una campagna](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/create-campaigns/create-a-campaign){target=_blank} in *Tutorial su Journey Optimizer*
