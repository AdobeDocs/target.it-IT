...
* **Feed di Recommendations**: notifiche quando un feed [!DNL Recommendations] viene attivato o disattivato, manualmente o da [!DNL Target]. Le notifiche vengono inviate anche quando un feed [!DNL Recommendations] non riesce.
...
1. Seleziona o deseleziona le categorie per le quali desideri ricevere le notifiche:
   ...
   * Altro:
   ...
   >[!NOTE]
   >
   >&quot;Nuove versioni&quot; e &quot;Aggiornamenti sul contenuto&quot; sono le uniche categorie di notifica applicabili a [!DNL Target]. Le altre categorie si applicano ad altre soluzioni di Adobe.
...
Per informazioni dettagliate su [!UICONTROL Recommendations] in [!DNL Target] e per ulteriori informazioni sull&#39;interfaccia utente di [!UICONTROL Recommendations], vedere [Recommendations](/help/main/c-recommendations/recommendations.md).
