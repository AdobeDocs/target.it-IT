...
Per ulteriori informazioni sulle versioni at.js, vedere [at.js versione details](https://experienceleague.adobe.com/it/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions){target=_blank} nella *Guida per sviluppatori Adobe Target*.

### Report di [!DNL Target] in [!DNL Adobe Customer Journey Analytics] (8 maggio 2024)

L&#39;integrazione tra [Adobe Customer Journey Analytics](https://experienceleague.adobe.com/it/docs/customer-journey-analytics){target=_blank} e [!DNL Target] offre potenti strumenti di analisi e risparmio di tempo per il programma di ottimizzazione.
...
* Aggiornamento del token dell&#39;interfaccia utente [!DNL Target] abilitato per le organizzazioni abilitate con [account Business ID](https://helpx.adobe.com/it/enterprise/using/identity.html){target=_blank} e autenticazione basata su criteri (PBA). (TGT-42590)
...
<table id="table_8525ECC9B6D0435ABEF8C27F747B7A0C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Da oggi, Internet Explorer 11 è supportato dall'interfaccia di Target. </p> <p>Vedere <a href="https://experienceleague.adobe.com/docs/target-dev/developer/implementation/supported-browsers.html?lang=it" format="dita" scope="local"> Browser Supportati </a>. </p> </td> 
  </tr> 
  <tr> 
