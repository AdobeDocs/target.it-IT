...
Per ulteriori informazioni, consulta la sezione [Documentazione dell’SDK Python](https://developer.adobe.com/target/implement/server-side/python/) in [Guida per gli sviluppatori di Adobe Target](https://developer.adobe.com/target/).
