...
Utilizza la pagina [!UICONTROL Stato del sistema di Adobe] e le notifiche proattive per essere sempre al corrente dello stato di [!DNL Adobe] prodotti e soluzioni [!DNL Adobe Experience Cloud]. Le notifiche proattive ti avvisano in caso di interruzioni o interventi di manutenzione.

## Aggiornamenti dello stato del sistema

Utilizzare la pagina [!UICONTROL Stato del sistema di Adobe] per visualizzare lo stato di [!DNL Target] e di altri prodotti [!DNL Adobe] e soluzioni [!DNL Adobe Experience Cloud]. Questa pagina è utile per determinare se eventuali problemi riscontrati sono dovuti a un aggiornamento del sistema o a un intervento di manutenzione ordinaria.
...
1. Accedere a [[!UICONTROL Stato sistema]](https://status.adobe.com/it){target=_blank}.
...
1. (Facoltativo) Filtrare l’elenco per prodotti, aree geografiche o intervalli di date. Fai clic sui collegamenti [!UICONTROL Principale], [!UICONTROL Minore], [!UICONTROL Potenziale] o [!UICONTROL Manutenzione] per filtrare ulteriormente i risultati.
