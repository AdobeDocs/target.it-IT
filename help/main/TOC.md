...
+ Amministrare Target {#administer}
  ...
  + [Pre-hiding dei contenuti](administrating-target/content-pre-hiding.md)
...
+ Server MCP di Adobe Target {#mcp}
  + [Panoramica](c-integrating-target-with-mac/mcp/target-mcp.md)
  + [Introduzione](c-integrating-target-with-mac/mcp/target-mcp-get-started.md)
  + [Casi d’uso e procedure dettagliate](c-integrating-target-with-mac/mcp/target-mcp-use-cases.md)
  + [Riferimento strumenti server MCP](c-integrating-target-with-mac/mcp/target-mcp-tools-reference.md)
+ Integrare Target con Experience Cloud {#integrate}
  ...
  + Integrare Target con Adobe Journey Optimizer (AJO) {#ajo}
    ...
    + {hide-from-toc}[Integrare [!DNL Adobe Target Recommendations] e [!DNL Adobe Journey Optimizer]](/help/main/c-integrating-target-with-mac/ajo/recs-ajo-integration.md)
...
+ Consigli {#recommendations}
  ...
  + Attività {#recommendations-activity}
    ...
    + {hide-from-toc}[Anteprima e avvio di un’attività Consigli](/help/main/c-recommendations/t-create-recs-activity/previewing-and-launching-your-recommendations-activity.md)
