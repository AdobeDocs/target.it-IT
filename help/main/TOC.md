...
+ Integrare Target con Experience Cloud {#integrate}
   ...
   + Integrare Target con Adobe Experience Manager (AEM) {#aem}
      + [Panoramica sull’integrazione di Target con Adobe Experience Manager (AEM)](/help/main/c-integrating-target-with-mac/aem/aem-target-integration.md)
...
+ Attività {#activities}
   ...
   + Targeting automatico {#auto-target}
      ...
      + [Creazione di rapporti e Targeting automatico](/help/main/c-activities/auto-target/reporting-and-auto-target.md)
