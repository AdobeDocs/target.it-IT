...
Utilizza il pannello [!UICONTROL Stili] per visualizzare o modificare il valore degli stili esistenti per l&#39;elemento selezionato. Inoltre, è possibile aggiungere ulteriore formattazione.

Per accedere al pannello [!UICONTROL Stili], fai clic su un elemento di pagina nel Compositore esperienza visivo, quindi su **[!UICONTROL Modifica]** > **[!UICONTROL Stili]**.
...
Quando applichi stili diversi, puoi sempre ripristinare le modifiche facendo clic sull&#39;icona [!UICONTROL Ripristina] che viene visualizzata nell&#39;angolo in alto a destra del pannello [!UICONTROL Stili] dopo aver modificato una sezione. Facendo clic sull&#39;icona [!UICONTROL Ripristina], vengono ripristinate tutte le modifiche nel pannello della sezione corrente.

Espandi ogni sezione per modificare o aggiungere stili, come descritto di seguito. Per salvare le modifiche, fai clic sull&#39;icona [!UICONTROL Indietro] nella parte superiore del pannello per tornare alla visualizzazione principale, quindi fai clic su **[!UICONTROL Salva]**.
...
* **[!UICONTROL Editor CSS]**
  ...
  Osserva i punti blu accanto alle opzioni [!UICONTROL Tipografia], [!UICONTROL Bordo] e [!UICONTROL Dimensione] nell&#39;illustrazione precedente. Questi punti indicano che le sezioni sono state modificate. Se apri questi pannelli di sezione, i punti blu vengono visualizzati accanto alle opzioni modificate.

  Se per impostazione predefinita lo stile desiderato non è disponibile in [!UICONTROL Stili], è possibile digitare il codice desiderato.
...
Disponibile per le attività [!UICONTROL A/B], [!UICONTROL Automated Personalization] e [!UICONTROL Test multivariato].
...
[!UICONTROL Recommendations] supporta [!UICONTROL Inserire prima] il contenuto dei tag DIV, SECTION e ARTICLE.

**Nota:** l’inserimento di un’immagine richiede che [!DNL Adobe Scene7 Publishing System] sia abilitato, in modo da avere accesso alla libreria delle immagini.
...
[!UICONTROL Recommendations] supporta [!UICONTROL Inserire dopo] il contenuto dei tag DIV, SECTION e ARTICLE.
...
Consulta [!UICONTROL Ridisponi] qui sopra per ulteriori informazioni sul comportamento incoerente con le azioni [!UICONTROL Sposta] e [!UICONTROL Ridisponi] a causa di un caricamento lento degli elementi DOM.
...
## [!UICONTROL Passa al collegamento]
