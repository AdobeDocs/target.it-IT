...
Il [!UICONTROL Conflitti] scheda della [!UICONTROL Panoramica delle attività] pagina in [!DNL Adobe Target] elenca i conflitti tra attività sul sito.
...
Il [!UICONTROL Conflitti] l&#39;elenco mostra ogni [!DNL Target] scenario in cui viene utilizzata la mbox e che utilizza lo stesso URL. Per ogni potenziale conflitto, l’elenco mostra l’URL dell’attività, il nome della mbox in cui potrebbe verificarsi il conflitto e tutte le attività che corrispondono a entrambi i criteri. In presenza di mbox multiple, ciascuna viene visualizzata nell’elenco.
