...
# [!UICONTROL Modifiche al Compositore esperienza visivo]

La versione di [!DNL Adobe Target Standard/Premium] 25.2.1 (17 febbraio 2015) introduce un [!UICONTROL Compositore esperienza visivo] aggiornato. Questo articolo spiega le differenze tra la versione precedente e quella aggiornata del Compositore esperienza visivo.
...
Come nella versione precedente, la barra [!UICONTROL Esperienze] rimane sul lato sinistro del Compositore esperienza visivo. Impossibile comprimere la barra [!UICONTROL Esperienze].

![Barra delle esperienze](/help/main/c-experiences/c-visual-experience-composer/assets/experiences-panel.png)

Puoi creare, rinominare o rimuovere le esperienze utilizzando la barra [!UICONTROL Esperienze]. Fai clic sull&#39;icona **[!UICONTROL Aggiungi]** ( ![Aggiungi icona](/help/main/assets/icons/Add.svg) ) per aggiungere una nuova esperienza. Fai clic sull&#39;icona [!UICONTROL Altre azioni] ( ![Altre azioni](/help/main/assets/icons/MoreSmall.svg) ) per duplicare, eliminare o reindirizzare un&#39;esperienza.

### [!UICONTROL Componenti] barra (nuova)
...
Per aggiungere un nuovo componente, seleziona il componente desiderato dalla barra [!UICONTROL Componenti], passa il puntatore del mouse su un elemento esistente nella pagina, quindi scegli di inserire il componente prima o dopo l&#39;elemento selezionato.
...
Per aprire la barra [!UICONTROL Modifiche], fai clic sull&#39;icona [!UICONTROL Mostra modifiche] ( ![Mostra barra Modifiche](/help/main/assets/icons/History.svg) ) nella barra [!UICONTROL Componenti]. La barra [!UICONTROL Modifiche] ha cambiato posizione dal lato destro a quello sinistro dell&#39;area di modifica.
...
La barra [!UICONTROL Modifiche] mostra tutte le modifiche apportate alla pagina nel Compositore esperienza visivo e consente di apportare ulteriori modifiche (ad esempio Selettore CSS, Mbox e Codice personalizzato).

Fai clic sull&#39;icona [!UICONTROL Altre opzioni] ( ![Altre azioni](/help/main/assets/icons/MoreSmall.svg) ) per aggiungere una modifica, eliminare tutte le modifiche o eliminare tutte le modifiche non valide. Fai clic su [!UICONTROL Seleziona] per eseguire operazioni in blocco: [!UICONTROL Applica a tutte le pagine] o [!UICONTROL Elimina].

Per visualizzare di nuovo la barra [!UICONTROL Modifiche], fai clic sull&#39;icona [!UICONTROL Nascondi modifiche] ( ![Mostra barra Modifiche](/help/main/assets/icons/History.svg) ) nella barra [!UICONTROL Modifiche].

### [!UICONTROL Barra delle proprietà] (nuova)
...
La barra [!UICONTROL Proprietà] è comprimibile nella barra a destra. Fai clic sull&#39;icona [!UICONTROL Mostra/Nascondi proprietà] ( ![icona Proprietà](/help/main/assets/icons/Propertie.svg) ) a destra della barra per comprimere o visualizzare la barra [!UICONTROL Proprietà].

### Impostazioni/configurazione delle attività

Fai clic sull&#39;icona [!UICONTROL Configura] ( ![Icona Configura](/help/main/assets/icons/Setting.svg) ) visualizzata nell&#39;area di progettazione per visualizzare il menu delle proprietà dell&#39;attività.

![Opzioni di configurazione attività](/help/main/c-experiences/c-visual-experience-composer/assets/configure-options.png)

Le diverse opzioni ti consentono di assegnare proprietà, modificare le regole di consegna delle pagine, specificare le preferenze del sito, aggiungere ulteriori pagine e abilitare o disabilitare attività con più pagine o tipi di pubblico. Assegna [!UICONTROL proprietà] è una funzionalità di [[!DNL Target Premium]](/help/main/c-intro/intro.md#premium).
...
Utilizza le opzioni [!UICONTROL Progettazione]/[!UICONTROL Sfoglia] visualizzate sopra la barra [!UICONTROL Proprietà] per passare dalla modalità progettazione alla modalità Sfoglia.
...
L&#39;area di lavoro [!UICONTROL Progettazione] consente di selezionare i riquadri di visualizzazione, incluso Adatta allo schermo, [!UICONTROL Desktop], [!UICONTROL Tablet], [!UICONTROL Orizzontale mobile] e [!UICONTROL Verticale mobile].
...
* [[!UICONTROL Modifiche al Compositore esperienza visivo]](/help/main/c-experiences/c-visual-experience-composer/vec-changes.md): la versione [!DNL Adobe Target Standard/Premium] 25.2.1 (17 febbraio 2025) introduce una versione aggiornata del [!UICONTROL Compositore esperienza visivo]. Questo articolo spiega le differenze tra le versioni legacy e aggiornata del Compositore esperienza visivo.
