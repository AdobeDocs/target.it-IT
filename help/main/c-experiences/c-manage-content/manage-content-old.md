...
Utilizza la libreria [!UICONTROL Offerte] in [!DNL Adobe Target] per gestire il contenuto delle offerte basate su codice e immagini.
...
1. Fai clic su **[!UICONTROL Offerte]** per aprire la libreria.
   ...
   La pagina [!UICONTROL Offerte] presenta due schede sul lato destro: [!UICONTROL Offerte codice] e [!UICONTROL Offerte immagine] che consentono di visualizzare le offerte per tipo.
...
1. (Facoltativo) Esegui altre attività passando il mouse sull&#39;offerta o sulla cartella desiderata nella scheda [!UICONTROL Offerte codice] e facendo clic sull&#39;icona desiderata.
   ...
   * Modifica
   * Copia
   * Sposta (ad esempio, per spostare uno o più elementi in una cartella, fai clic sull&#39;icona **[!UICONTROL Sposta]** per l&#39;elemento desiderato, fai clic sulla cartella desiderata, quindi fai clic su **[!UICONTROL Rilascia]**.)
   * Elimina
...
1. (Facoltativo) Esegui altre attività passando il mouse sull&#39;offerta o sulla cartella di immagine desiderata nella scheda [!UICONTROL Offerte immagine] e facendo clic sull&#39;icona desiderata.
...
Puoi visualizzare i dettagli della definizione dell&#39;offerta in una scheda a comparsa nella libreria [!UICONTROL Offerte] senza aprire l&#39;offerta.
