...
| Cerca campi | Trovare rapidamente un&#39;attività o ridurre il numero di attività visualizzate nell&#39;elenco [!UICONTROL Activity]. È possibile eseguire ricerche per [!UICONTROL Activity Name], [!UICONTROL URL] o [!UICONTROL ID] utilizzando il menu a discesa.<P>Le opzioni di ricerca configurate sono permanenti nella sessione corrente. |
