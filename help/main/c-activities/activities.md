...
![Elenco attività](/help/main/c-activities/assets/activities-list-new.png)
...
| [!UICONTROL Elimina] | Elimina una bozza o un’attività.<P>**NOTA**: non è possibile recuperare le attività eliminate. A meno che tu non sia sicuro che questa attività non sarà mai più necessaria, utilizza [!UICONTROL Archivia] azione. Se necessario, puoi quindi riattivare l’attività. |
