...
description: Scopri come utilizzare le attività [!UICONTROL Targeting esperienza] (XT) in [!DNL Adobe Target] per distribuire contenuti a un pubblico specifico in base a una serie di regole e criteri definiti dall'addetto al marketing.
title: Che cos'è un'attività [!UICONTROL Targeting esperienza] (XT)?
...
Questo video descrive come portare il test A/B al livello successivo con [!UICONTROL Targeting esperienza].
