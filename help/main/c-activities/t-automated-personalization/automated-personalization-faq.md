...
title: Come posso trovare le domande frequenti sulle [!UICONTROL attività Automated Personalization]?
...
Non è disponibile alcuna opzione chiavi in mano per confrontare [!UICONTROL Automated Personalization] con un&#39;esperienza predefinita. Tuttavia, come soluzione alternativa, se esiste un&#39;offerta o un&#39;esperienza predefinita come parte dell&#39;attività complessiva, per comprenderne le prestazioni di base, fai clic sul segmento &quot;[!UICONTROL Controllo]&quot; nei report e individua tale offerta nel report a livello di offerta risultante. Il tasso di conversione registrato per questa offerta può essere utilizzato per confrontare con il tasso di conversazione dell’intero segmento &quot;Foresta casuale&quot;. Questo permette di confrontare le prestazioni della macchina rispetto all’offerta predefinita.
...
* Presta particolare attenzione alla *forma attività* (numero di posizioni × numero di offerte), non solo al conteggio totale delle esperienze. Le combinazioni cartesiane di posizioni e offerte determinano prestazioni in termini di tempo di authoring superiori al numero non elaborato di esperienze.
* Per prestazioni e gestibilità ottimali, limita le attività [!UICONTROL Automated Personalization] e [!UICONTROL Targeting automatico] a 4-6 posizioni con 4-6 offerte per posizione. Configurazioni più grandi non sono consigliate, possono causare rallentamenti nel caricamento o nella modifica nel [!UICONTROL Compositore esperienza visivo] e possono essere soggette a restrizioni nell&#39;interfaccia utente [!DNL Target]. Nell&#39;interfaccia utente corrente, [!DNL Target] visualizza avvisi in linea o impedisce il salvataggio dell&#39;attività quando la configurazione supera le soglie supportate.
...
Lo stesso limite viene applicato anche quando l&#39;attività ha abilitato l&#39;opzione [!UICONTROL Non consentire duplicati].

Anche se le attività [!UICONTROL Automated Personalization] e [!UICONTROL Targeting automatico] possono supportare un numero elevato di esperienze, le prestazioni di authoring dipendono in larga misura dalla *forma attività* (numero di posizioni × numero di offerte). Alcune configurazioni creano grandi combinazioni cartesiane che possono avere un impatto significativo sul carico e sulle prestazioni di modifica, anche al di sotto dei limiti di esperienza documentati.

Per prestazioni e gestibilità ottimali, limita le attività [!UICONTROL Automated Personalization] e [!UICONTROL Targeting automatico] a 4-6 posizioni con 4-6 offerte per posizione. Configurazioni più grandi non sono consigliate e potrebbero essere soggette a restrizioni nell&#39;interfaccia utente [!DNL Target].

Nell&#39;interfaccia utente [!DNL Target] corrente, le attività [!UICONTROL Automated Personalization] e [!UICONTROL Targeting automatico] sono configurate direttamente nel passaggio [!UICONTROL Esperienze]. [!DNL Target] potrebbe visualizzare avvisi in linea o impedire il salvataggio di attività quando le configurazioni superano le soglie supportate e riconvalida la forma attività in [!UICONTROL Avanti], [!UICONTROL Salva] e [!UICONTROL Pubblica].
...
## Perché la mia attività [!UICONTROL Automated Personalization] non mostra l&#39;incremento? {#section_BFA07C8C258F45318F73A461B8F32737}
...
## In che modo [!UICONTROL Automated Personalization] alloca il traffico della mia attività? {#section_4369364F77804E0D9B78BEE551DA5659}
...
## Un modello è stato creato nell&#39;attività [!UICONTROL Automated Personalization]. Le visite a quell’esperienza sono personalizzate? {#section_51EA953C6D1D4A3185FC9DD290D66621}
...
Puoi iniziare a esaminare i risultati dell&#39;attività [!UICONTROL Automated Personalization] quando disponi di almeno due esperienze con modelli generati (segno di spunta verde) per l&#39;esperienza con modelli generati.
...
[!UICONTROL Le attività Automated Personalization] vengono valutate una volta per sessione. Se ci sono sessioni attive idonee per una particolare esperienza e ora sono state aggiunte nuove offerte, i visitatori vedranno il nuovo contenuto insieme alle offerte precedentemente mostrate. Poiché questi visitatori in precedenza erano qualificati per tali esperienze, le visualizzano ancora durante la sessione. Per valutare questa situazione a ogni visita di pagina, devi passare al tipo di attività [!UICONTROL Targeting esperienza] (XT).
...
## È possibile utilizzare l&#39;opzione [!UICONTROL Ripristina dati report] durante l&#39;esecuzione di un&#39;attività [!UICONTROL Automated Personalization]?

+++Vedi i dettagli

[!DNL Adobe] sconsiglia di utilizzare l&#39;opzione [!UICONTROL Ripristina dati report] per [!UICONTROL attività Automated Personalization]. Anche se rimuove i dati di reporting visibili, questa opzione non rimuove tutti i record di formazione dal modello [!UICONTROL Automated Personalization]. Invece di utilizzare l&#39;opzione [!UICONTROL Ripristina dati report] per [!UICONTROL attività Automated Personalization], crea una nuova attività e disattiva l&#39;attività originale. Questa guida si applica anche alle attività [!UICONTROL Allocazione automatica] e [!UICONTROL Targeting automatico].

+++

## In che modo [!UICONTROL Automated Personalization] genera modelli in relazione agli ambienti?
...
Il traffico proveniente da un secondo set di modelli viene generato per ogni gruppo di modeling ([!UICONTROL Automated Personalization]) o esperienza ([!UICONTROL Targeting automatico]). Per ciascuno di questi modelli, vengono considerati gli hit e le conversioni in tutti gli ambienti.
