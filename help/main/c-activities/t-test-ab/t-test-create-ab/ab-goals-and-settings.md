...
La pagina Obiettivi e impostazioni in [!DNL Adobe Target] è il punto in cui vengono immesse le informazioni sugli obiettivi del test.

Le impostazioni disponibili dipendono dall’utilizzo di Target o [Analytics](/help/main/c-integrating-target-with-mac/a4t/a4t.md) come origine di dati.

![Finestra di dialogo Impostazioni attività](/help/main/c-activities/t-test-ab/t-test-create-ab/assets/ab_settings-new.png)
