...
description: Scopri come utilizzare la pagina [!UICONTROL Goals and Settings] per definire gli obiettivi dell'attività A/B.
...
La sezione [!UICONTROL Advanced Settings] della pagina [!UICONTROL Goals & Settings] consente di configurare le opzioni avanzate.

Per specificare le impostazioni avanzate, fare clic sull&#39;icona **[!UICONTROL More]** ( ![Icona Altro](/help/main/assets/icons/MoreSmallList.svg) ) nella sezione [!UICONTROL My Primary Goal], quindi fare clic su **[!UICONTROL Advanced Settings]**.
