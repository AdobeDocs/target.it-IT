...
Un successo [!UICONTROL Test A/B] attività in [!DNL Adobe Target] richiede un numero sufficiente di visitatori (dimensioni del campione) per migliorare il tasso di conversione. Come sai per quanto tempo eseguire un test A/B? Questo articolo contiene informazioni su [!UICONTROL Allocazione automatica] e [!UICONTROL Adobe Target] Calcolatore dimensioni campione per assicurarti che l’attività abbia abbastanza visitatori per raggiungere gli obiettivi.
...
>[!IMPORTANT]
>
>L’arresto prematuro di un’attività è una delle dieci insidie significative a cui potresti essere vittima durante l’esecuzione di un test A/B. Per ulteriori informazioni, consulta [Dieci insidie frequenti per i test A/B e come evitarle](/help/main/c-activities/t-test-ab/common-ab-testing-pitfalls.md#concept_578A7947C9554868B30F12DFF9E3F8E3).
...
In un test A/B, si presume inizialmente che entrambe le offerte abbiano lo stesso tasso di conversione. La probabilità del risultato osservato è quindi calcolata sulla base di questo presupposto. Se questa probabilità (il valore p) è inferiore ad una soglia predefinita (il livello di significatività), [!DNL Target] conclude che il presupposto iniziale, ovvero che entrambe le offerte abbiano lo stesso tasso di conversione, non è corretto. E, quindi, i tassi di conversione di A e B sono statisticamente diversi a un determinato livello di significatività.
