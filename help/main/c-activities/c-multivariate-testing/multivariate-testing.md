...
description: Scopri come utilizzare un [!UICONTROL Test multivariato] (MVT) in [!DNL Adobe Target] confrontare le combinazioni di offerte negli elementi di una pagina per determinare quale combinazione funziona meglio.
...
A [!UICONTROL Test multivariato] (MVT) attività in [!DNL Adobe Target] confronta le combinazioni di offerte negli elementi di una pagina per determinare quale combinazione funziona meglio per un pubblico specifico. A [!UICONTROL Test multivariato] L’attività consente inoltre di identificare quale elemento influisce maggiormente sul successo dell’attività.
...
## Quando utilizzare [!UICONTROL Test multivariato] e A/B {#section_3D2B966B6671406C861A1843EA41D28C}
...
Questo video spiega come comprendere, pianificare e creare un test multivariato utilizzando [!DNL]Flusso di lavoro guidato in tre passaggi di Target.
