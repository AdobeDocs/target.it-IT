...
description: Scopri come utilizzare Multivariate Testing (MVT) in Adobe [!DNL Target] confrontare combinazioni di offerte negli elementi di una pagina per determinare quale combinazione funziona meglio.
