...
description: Scopri come utilizzare la pagina [!UICONTROL Obiettivi e impostazioni] in [!DNL Adobe Target] per specificare informazioni sugli obiettivi di un'attività [!UICONTROL Test multivariato] (MVT).
...
Se questa opzione non è abilitata in [!UICONTROL Amministrazione] > [!UICONTROL Generazione rapporti] (impostazione predefinita), specificare una priorità: [!UICONTROL Bassa], [!UICONTROL Medium] o [!UICONTROL Alta].
...
Per le attività create con le versioni precedenti di [!DNL Target], la priorità [!UICONTROL Bassa] è convertita in 0, la priorità [!UICONTROL Medium] è convertita in 5 e la priorità [!UICONTROL Alta] in 10. Se necessario, è possibile modificare questi valori.
...
Le impostazioni avanzate sono disponibili per [!UICONTROL Metriche obiettivo test multivariato].
...
* [!UICONTROL Selezionare Incrementa il conteggio e mantieni l&#39;utente nell&#39;attività] per specificare la modalità di incremento del conteggio.
