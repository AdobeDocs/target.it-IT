...
1. Quando viene richiesto durante la [creazione dell’attività](/help/main/c-activities/c-multivariate-testing/t-create-multivariate-test/create-multivariate-test.md), specifica l’URL attività. Digita l&#39;URL completo (incluso `https://`), quindi fai clic su **[!UICONTROL Crea]**.
...
1. (Condizionale) Per visualizzare una pagina diversa dopo l&#39;apertura del Compositore esperienza visivo, fai clic sull&#39;icona **[!UICONTROL Configura]**, seleziona **[!UICONTROL Consegna pagine]**, quindi specifica l&#39;URL.
