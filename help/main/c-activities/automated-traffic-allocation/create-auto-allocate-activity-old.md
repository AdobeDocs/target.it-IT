...
description: Scopri come utilizzare il [!UICONTROL Compositore esperienza visivo] (VEC) in [!DNL Adobe Target] per creare un'attività di test A/B [!UICONTROL Allocazione automatica].
...
1. Nella finestra di dialogo **[!UICONTROL Crea attività test A/B]**, seleziona **[!UICONTROL Visivo]**, se necessario.
...
1. Specifica l&#39;[URL attività](/help/main/c-activities/t-test-ab/t-test-create-ab/ab-activity-url.md), quindi fai clic su **[!UICONTROL Crea]**.
...
1. Imposta il metodo di allocazione del traffico.
   ...
   Scegli il metodo di allocazione del traffico desiderato. Per creare un&#39;attività [!UICONTROL Allocazione automatica], selezionare **[!UICONTROL Allocazione automatica all&#39;esperienza migliore]**.
