...
Informazioni sull&#39;utilizzo dei dati dei clienti aziendali dai database CRM (Customer Relationship Management) per il targeting del contenuto in [!DNL Adobe Target] tramite l&#39;utilizzo degli attributi del cliente nel servizio [!DNL Adobe Experience Cloud People].

I dati dei clienti aziendali raccolti tramite più origini e memorizzati all&#39;interno dei database CRM possono essere utilizzati in [!DNL Target] per fornire in modo strategico il contenuto più pertinente ai clienti, specificatamente concentrandosi sui clienti fidelizzati. Audiences e Attributi del cliente nel servizio [!DNL People] (già Profili e tipi di pubblico) riuniscono la raccolta e l&#39;analisi dei dati con test e ottimizzazione, rendendo immediatamente fruibili i dati e le informazioni.

## Panoramica degli attributi del cliente {#section_B4099971FA4B48598294C56EAE86B45A}

[Attributi del cliente](https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/attributes.html) nel servizio [!DNL People] fa parte di [!DNL Adobe Experience Cloud] e fornisce alle aziende uno strumento per inviare i dati dei clienti alla piattaforma [!DNL Experience Cloud].
...
* Per poter utilizzare la funzionalità [!UICONTROL Customer Attributes] nel servizio [!DNL People], è necessario soddisfare alcuni prerequisiti. Per ulteriori informazioni, vedere &quot;Prerequisiti per il caricamento di attributi del cliente&quot; in [Attributi del cliente](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/attributes.html#section_BD38693AFBF34926BA28E964963B4EA0) nella *guida per l&#39;amministrazione e l&#39;interfaccia di Experience Cloud*.
* Tieni presente le limitazioni relative al caricamento di file, come documentato in [File di dati e origini degli attributi del cliente](https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/crs-data-file.html?lang=it) nella *Guida all&#39;interfaccia e all&#39;amministrazione di Experience Cloud*. Best practice:
...
* La durata dei dati Attributi del cliente importati da [!DNL Experience Cloud] in [!DNL Target] dipende dalla durata del profilo del visitatore, che è di 14 giorni per impostazione predefinita. Per ulteriori informazioni, consulta [Durata del profilo del visitatore](/help/main/c-target/c-visitor-profile/visitor-profile-lifetime.md#concept_D9F21B416F1F49159F03036BA2DD54FD).
...
1. In [!DNL Experience Cloud], fai clic sull&#39;icona del menu ( ![icona del menu](/help/main/c-target/c-visitor-profile/assets/menu-icon.png) ), quindi fai clic su **[!UICONTROL People]**.

   ![Persone](/help/main/c-target/c-visitor-profile/assets/people.png)

1. Fare clic su **[!UICONTROL Customer Attributes]**.
...
Le istruzioni dettagliate per il completamento di ciascuna delle seguenti attività sono disponibili in [Creazione di un&#39;origine attributo del cliente e caricamento del file di dati](https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/t-crs-usecase.html) nella guida *Amministrazione e interfaccia di Experience Cloud*.
...
### Creare tipi di pubblico di targeting
...
### Creare script di profilo utilizzando i token
...
### Utilizzare mbox3rdPartyID nel sito web per una corretta implementazione e utilizzo
...
### Utilizzare il servizio Experience Cloud ID

Se utilizzi il servizio Experience Cloud ID, devi impostare un ID cliente e uno stato di autenticazione per utilizzare gli attributi del cliente nel targeting. Per ulteriori informazioni, consulta [ID cliente e stati di autenticazione](https://experienceleague.adobe.com/docs/id-service/using/reference/authenticated-state.html) nella *guida del servizio Experience Cloud ID*.

Per ulteriori informazioni sull&#39;utilizzo degli attributi del cliente in [!DNL Target], vedere le risorse seguenti:

* [Crea e carica i dati degli attributi del cliente](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/t-crs-usecase.html) nella *guida per l&#39;amministrazione e l&#39;interfaccia di Experience Cloud*
