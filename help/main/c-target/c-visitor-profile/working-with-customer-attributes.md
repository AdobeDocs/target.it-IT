...
* Per poter utilizzare la funzionalità [!UICONTROL Attributi del cliente] nel servizio [!DNL People], è necessario soddisfare alcuni requisiti preliminari. Per ulteriori informazioni, consulta &quot;Prerequisiti per il caricamento di attributi del cliente&quot; in [Attributi del cliente](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/attributes.html#section_BD38693AFBF34926BA28E964963B4EA0) nella guida *Amministrazione e interfaccia di Experience Cloud*.
* Tieni presente le limitazioni relative al caricamento di file, come documentato in [File di dati e origini degli attributi del cliente](https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/crs-data-file.html?lang=it) nella guida *Amministrazione e interfaccia di Experience Cloud*. Best practice:
...
1. In [!DNL Experience Cloud], fai clic sull&#39;icona del menu ( ![icona menu](/help/main/c-target/c-visitor-profile/assets/menu-icon.png) ), quindi fai clic su **[!UICONTROL Persone]**.

   ![Persone](/help/main/c-target/c-visitor-profile/assets/people.png)

1. Fai clic su **[!UICONTROL Attributi del cliente]**.
...
* [Crea e carica i dati degli attributi del cliente](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/t-crs-usecase.html) nella guida *Amministrazione e interfaccia di Experience Cloud*
