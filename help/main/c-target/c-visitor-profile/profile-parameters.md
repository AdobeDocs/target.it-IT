...
Gli script di profilo sono disponibili nella scheda [!UICONTROL Tipi di pubblico] nell&#39;interfaccia [!DNL Target].
...
Per copiare uno script di profilo esistente, dall&#39;elenco [!UICONTROL Script di profilo] fare clic sull&#39;icona dei puntini di sospensione dello script desiderato, quindi fare clic su **[!UICONTROL Duplica]**.
...
Ad esempio, per accedere alla scheda di informazioni sullo script di profilo seguente fai clic sull&#39;icona [!UICONTROL Info] dello script di profilo desiderato dall&#39;elenco ([!UICONTROL Tipi di pubblico] > [!UICONTROL Script di profilo]).
...
>[!NOTE]
>
>Nella scheda [!UICONTROL Utilizzo script] non vengono visualizzate le attività che fanno riferimento allo script di profilo selezionato nelle situazioni seguenti:
>
...
* **Aggiungi script di profilo come token di risposta per eseguire il debug degli script di profilo:**
  ...
  In [!DNL Target], fare clic su **[!UICONTROL Amministrazione]**, su **[!UICONTROL Token di risposta]**, quindi abilitare lo script di profilo su cui si desidera eseguire il debug.
