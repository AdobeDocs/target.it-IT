...
1. Trascina e rilascia **[!UICONTROL Personalizzato]** nel generatore di pubblico.
   ...
   * Se ricordi il nome mbox ma non il nome del parametro, utilizza l&#39;elenco a discesa [!UICONTROL Filtra per] per filtrare in base a una mbox nota che trasmette il parametro desiderato.
   ...
   >[!NOTE]
   >
   >La mbox selezionata dall&#39;elenco a discesa [!UICONTROL Filtra per] non viene salvata durante la creazione dell&#39;attività. Questa opzione consente di filtrare i parametri in base alla mbox selezionata.
