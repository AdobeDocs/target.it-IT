...
[!DNL Target Recommendations] richiede di implementare [!DNL Adobe Experience Platform Web SDK] o at.js 0.9.2 (o versione successiva). Vedi [Implementare [!DNL Target]](/help/main/c-implementing-target/implementing-target.md) per ulteriori informazioni.
...
Per ulteriori informazioni [!UICONTROL Basato sul carrello] consigli, vedi [Basato sul carrello](/help/main/c-recommendations/c-algorithms/base-the-recommendation-on-a-recommendation-key.md#cart-based) in *Basare il consiglio su una chiave consiglio*.
...
Quando si verifica un evento di acquisto, trasmettere l&#39;identità dell&#39;articolo o degli articoli acquistati. Vedi [Tracciare le conversioni](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/implementing-target-without-a-tag-manager.md#task_E85D2F64FEB84201A594F2288FABF053) in *Implementare [!DNL Target] senza un gestore di tag*.

## Configurare le esclusioni globali {#exclusions}

Escludi gli elementi a livello globale che non vorresti consigliare a un visitatore. Consulta [Esclusioni](/help/main/c-recommendations/c-products/exclusions.md).
