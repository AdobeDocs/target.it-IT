...
Consulta la sezione [Documentazione API di Adobe Recommendations](https://developers.adobetarget.com/api/recommendations) per informazioni sull’utilizzo delle API di Consegna e Salva entità .
