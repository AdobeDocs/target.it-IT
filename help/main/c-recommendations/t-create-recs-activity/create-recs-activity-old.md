...
1. Selezionare **[!UICONTROL Visivo (predefinito)]**, se necessario.
   ...
   ![Finestra di dialogo Crea attività Consigli](/help/main/c-recommendations/t-create-recs-activity/assets/DB_NewRecAct.png)
...
1. Specificare un URL attività, quindi fare clic su **[!UICONTROL Avanti]**.
