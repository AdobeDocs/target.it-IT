...
## Aggiunta di regole di filtro a criteri e promozioni {#section_CD0D74B8D3BE4A75A78C36CF24A8C57F}

* **Criteri**: durante la [creazione dei criteri](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md#task_8A9CB465F28D44899F69F38AD27352FE), fare clic su **[!UICONTROL Add Filtering Rule]** in **[!UICONTROL Inclusion Rules]**.

  Le opzioni disponibili dipendono dal settore verticale selezionato e della chiave consiglio.

* **Promozioni**: durante la [creazione di una promozione](/help/main/c-recommendations/t-create-recs-activity/adding-promotions.md#task_CC5BD28C364742218C1ACAF0D45E0E14), selezionare **[!UICONTROL Promote by Attribute]**, quindi fare clic su **[!UICONTROL Add Filtering Rule]**.
