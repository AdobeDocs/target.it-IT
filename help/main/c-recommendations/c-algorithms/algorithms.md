...
Altre opzioni di criteri cambiano in base al settore verticale selezionato. Puoi impostare il settore predefinito in verticale su **[!UICONTROL Recommendations > Impostazioni]** o puoi specificare il settore verticale per ciascun criterio.

## Tipo di algoritmo {#section_885B3BB1B43048A88A8926F6B76FC482}

Il tipo di algoritmo selezionato determina quelli disponibili. Esistono diversi tipi di algoritmo che vengono rappresentati come schede di criteri quando imposti un [!DNL Recommendations] attività.
...
| --- | --- | --- |
| [!UICONTROL Basato su carrello] | Creare consigli in base al contenuto del carrello dell’utente. | <ul><li>Chi ha visualizzato questi ha visualizzato anche quelli</li><li>Chi ha visualizzato questi ha acquistato anche quelli</li><li>Chi ha comprato questi ha acquistato anche quelli</li></ul>Per ulteriori informazioni, consulta [Basato su carrello](/help/main/c-recommendations/c-algorithms/base-the-recommendation-on-a-recommendation-key.md#cart-based) in *Basare il consiglio su una chiave consiglio*. |
...
Per ulteriori informazioni su ciascun algoritmo, consulta [Basare il consiglio su una chiave consiglio](/help/main/c-recommendations/c-algorithms/base-the-recommendation-on-a-recommendation-key.md).
...
>[!NOTE]
>
>I parametri di profilo personalizzati possono essere trasmessi a [!DNL Target] tramite JavaScript, API o integrazioni. Per ulteriori informazioni sugli attributi di profilo personalizzati, consulta [Profili dei visitatori](/help/main/c-target/c-visitor-profile/visitor-profile.md).
...
1. Compila le informazioni nel [Sezione Informazioni di base](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md#info).

1. In [Algoritmo consigliato](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md#rec-algo) sezione, seleziona **[!UICONTROL Basato su articolo]** dal **[!UICONTROL Tipo di algoritmo]** elenco.

1. Seleziona **[!UICONTROL Chi ha visualizzato questo ha visualizzato anche quello]** dal **[!UICONTROL Algoritmo]** elenco.

1. Seleziona l’attributo di profilo personalizzato dall’elenco **[!UICONTROL Chiave consiglio]** (ad esempio, [!UICONTROL Ultimo programma aggiunto alla watchlist]).
