...
# Visualizzare l'anteprima e avviare l'attività di Recommendations

Dopo aver creato l'attività [!UICONTROL Recommendations], [!UICONTROL A/B Test]o [!UICONTROL Experience Targeting] (XT) contenente le offerte [](/help/c-recommendations/recommendations-as-an-offer.md)Recommendations, desiderate visualizzare l'anteprima delle raccomandazioni per assicurarvi che i risultati siano disponibili prima di avviare l'attività. [!DNL Target Recommendations] offre diversi modi per visualizzare l'anteprima delle raccomandazioni.
...
![Pagina Panoramica dell'attività di Recommendations](/help/c-recommendations/t-create-recs-activity/assets/recs-overview.png)
...
![Risultati, finestra di dialogo](/help/c-recommendations/t-create-recs-activity/assets/results.png)
...
## Utilizzo di collegamenti QA per visualizzare in anteprima Recommendations
...
Un file CSV viene scaricato. Aprirlo per visualizzare gli elementi consigliati:
...
>[!NOTE]
>
>I download dei risultati non sono disponibili per le attività contenenti un algoritmo [!UICONTROL User-Based Recommendations] . I download dei risultati non sono disponibili per i criteri che utilizzano la logica di raccomandazione Elementi [!UICONTROL visualizzati di] recente.

## Attivazione dell'attività di Recommendations
