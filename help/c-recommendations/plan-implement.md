...
# ![PREMIUM](/help/assets/premium.png) : pianificazione e implementazione di Recommendations {#plan-and-implement-recommendations}
...
|--- |--- |
| Mbox globale personalizzata | (Facoltativo) Specifica la mbox globale personalizzata utilizzata per le attività di [!DNL Target]. By default, the global mbox used by [!DNL Target] is used for [!DNL Recommendations].<br>Nota: Questa opzione è impostata nella pagina [!DNL Target][!UICONTROL Amministrazione] . Aprite [!DNL Target], quindi fate clic su [!UICONTROL Amministrazione] > [!UICONTROL Visual Experience Composer (Compositore esperienza visivo)]. |
