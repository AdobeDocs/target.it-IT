...
description: Scoprite le attività Recommendations in  Adobe Target che visualizzano automaticamente il contenuto che potrebbe interessare ai vostri clienti in base alle attività utente precedenti o ad altri algoritmi.
title: Cos'è Target Recommendations?
...
Prima di iniziare a utilizzare [!DNL Recommendations], è utile acquisire familiarità con alcuni termini utilizzati in questa sezione. Non preoccuparti se ancora non hai ancora capito appieno questi termini, potrai familiarizzare con loro durante la configurazione delle tue attività [!DNL Recommendations].

| Termine | Definizione |
| --- | --- |
| Attività | Le attività in [!DNL Target] consentono di personalizzare il contenuto per audience specifiche e di sottoporre a test le progettazioni delle pagine. [!DNL Recommendations] è solo uno dei molti tipi di attività disponibili in  [!DNL Target]. Per ulteriori informazioni, vedere [Tipi di attività di destinazione](/help/c-activities/target-activities-guide.md). |
| Entità | Le entità si riferiscono agli elementi che desideri consigliare. Le entità possono essere prodotti, contenuti (articoli, presentazioni, immagini, filmati e programmi televisivi), elenchi di lavoro, ristoranti e così via. Per ulteriori informazioni, vedere [Entità](/help/c-recommendations/c-products/products.md). |
...
| Raccolta | Le raccolte fanno riferimento a un insieme di elementi simili o correlati, ad esempio una singola categoria di prodotti. Tuttavia, puoi raggruppare qualsiasi elemento in una categoria adatta alla tua attività specifica, come prodotti in una determinata fascia di prezzo o colore o che possono essere di interesse in una particolare area geografica. Per ulteriori informazioni, vedere [Raccolte](/help/c-recommendations/c-products/collections.md). |
...
| Progettazione | Le progettazioni definiscono l&#39;aspetto delle raccomandazioni in un&#39;attività [!DNL Recommendations], come una riga, una colonna, una tabella o una griglia. L&#39;illustrazione nella parte superiore di questo articolo mostra un design 4 x 1. Per ulteriori informazioni, vedere [Creare una progettazione](/help/c-recommendations/c-design-overview/create-design.md). |
...
## Webinar sulle nozioni di base di Adobe Target: introduzione alla funzione consigli ![Etichetta esercitazione](/help/assets/tutorial.png) {#intro-to-recs}
