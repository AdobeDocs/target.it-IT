...
description: In questa pagina sono elencate le modifiche importanti apportate alla documentazione del Adobe Target , ordinate per rilascio.
...
| --- | --- | --- |
| 4 agosto | [Annunci ed eventi Target](/help/r-release-notes/target-announcements.md) | Sono state aggiunte informazioni di registrazione sul webinar &quot;Personalization Strategies Using Artificial Intelligence and  Adobe Target&quot;, in programma per il 13 agosto. |
...
| Data | Argomento | Modifiche |
| --- | --- | --- |
| Luglio 17 | [Annunci ed eventi Target](/help/r-release-notes/target-announcements.md) | Sono state aggiunte informazioni sull&#39;interruzione di caffè del Adobe Target del 22 luglio . |
...
| 8 giugno | [Domande frequenti su Target per le app per dispositivi mobili](/help/c-target-mobile-app/target-for-mobile-apps-faq.md) | Testo aggiornato per le seguenti domande frequenti: &quot;Target Mobile è una funzionalità  Adobe Target Premium Product SKU solo?&quot; |
...
| 5 giugno | [Annunci ed eventi Target](/help/r-release-notes/target-announcements.md) | Sono state aggiunte informazioni sulla pausa caffè del Adobe Target del 10 giugno . |
...
|  | [Note sulla versione di Target (prerelease)](/help/r-release-notes/target-release-notes.md) | È stata modificata la data della release Target Standard/Premium (20.4.1) in 6 maggio. |
...
| 20 marzo | [Note sulla versione (corrente)](/help/r-release-notes/release-notes.md) | Indicato che la versione Target Standard/Premium 20.2.1 sarà il 23 marzo 2020. |
...
|  | [Dettagli sulle versioni di at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) | Testo chiarito che spiega quali versioni di at.js supportate dal team Target. |
