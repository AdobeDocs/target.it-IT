...
seo-title: Modifiche alla documentazione
solution: Target
...
|  | [adobe. target. getoffer (options) - at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Sono state aggiunte righe alla tabella per i seguenti nomi di campo:<ul><li>Request &gt; experiencecloud</li><li>Request &gt; experiencecloud &gt; analytics</li><li>Request &gt; experiencecloud &gt; analytics &gt; logging</li></ul> |
|  | [Funzioni di at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/cmp-atjs-functions.md) | Added row to the table for `adobe.target.sendNotifications(options)`. |
...
|  | [Aggiornamento da. js 1. x a. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#integrations) | Aggiunte informazioni sul supporto di Adobe Consenso in at. js 2.1.0. |
|  | [Privacy e Regolamento generale sulla protezione dei dati (RGPD)](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/cmp-privacy-and-general-data-protection-regulation.md) | Aggiornate informazioni sul supporto consenso in at. js 2.1.0. |
| 31 maggio 2019 | [Mobile](/help/c-target/c-audiences/c-target-rules/mobile.md) | Nota relativa ai dispositivi di destinazione con iOS 12.2. |
|  | [Pianificare e implementare Consigli](/help/c-recommendations/plan-implement.md) | Esempio di codice aggiornato. |
...
|  | [Risolvere i problemi relativi alla distribuzione dei contenuti](/help/c-activities/c-troubleshooting-activities/content-trouble.md) | Aggiunta nuova sezione di risoluzione dei problemi su at. js non attivazione delle mbox se state utilizzando un doctype non valido. |
...
|  | [Introduzione a Target](/help/c-intro/intro.md#kit) | Aggiunto collegamento al kit di benvenuto di Adobe Target. |
...
**Nota**: La versione di Target Standard/Premium 19.4.1 era una versione di maimence per aggiornare l&#39;interfaccia utente di Adobe Experience Cloud in modo da riflettere le modifiche al marchio e al prodotto.

| Data | Argomento | Modifiche |
| --- | --- | --- |
| 15 maggio 2019 | [Implementazione di un&#39;applicazione a pagina singola](/help/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/target-atjs-single-page-application.md#triggerview) | Aggiunta nota sulla necessità di attivare ed `at-view-start``at-view-end` eventi. |
| 14 maggio 2019 | [Mobile App Visual Experience Composer](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md),<br>[Android - Configurazione dell&#39;app mobile](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-android.md),<br>[iOS - Configurazione dell&#39;app mobile](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-ios.md), tramite Configurazione<br>[del monitoraggio dei clic nell&#39;aula virtuale](/help/c-target-mobile-app/c-mobile-visual-experience-composer/set-up-click-tracking-in-the-mobile-vec.md) | Nuovi argomenti. |
...
| 13 maggio 2019 | [Controllo di qualità delle attività](/help/c-activities/c-activity-qa/activity-qa.md) | Aggiunta dell&#39;elemento nell&#39;elenco Considerazioni sull&#39;utilizzo della modalità QA in un&#39;attività multi-pagina. |
|  | [Includere la stessa esperienza in pagine simili](/help/c-experiences/c-visual-experience-composer/temtest.md) | Sono stati aggiornati i passaggi per far corrispondere l&#39;interfaccia utente. |
|  | [Domande frequenti su at.js ](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-atjs-faq/target-atjs-faq.md) | Sono state aggiunte nuove domande frequenti: &quot; What HTML doctype does at. js require? &quot; |
...
| 9 maggio 2019 | [Generazione di rapporti per A4T](/help/c-integrating-target-with-mac/a4t/reporting.md#reports-in-analysis-workspace) | Aggiunta nuova sezione: «Rapporti in Analysis Workspace». |
|  | [Visualizzare i rapporti - Domande frequenti su A4T](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-viewing-reports.md) | Sono state aggiunte nuove domande frequenti: &quot; Posso visualizzare i dati dell&#39;attività Target in Adobe Analysis Workspace? &quot; |
|  | [Autorizzazioni per gli utenti aziendali](/help/administrating-target/c-user-management/property-channel/property-channel.md#faqs) | Sono state aggiunte nuove domande frequenti: &quot; Sono state registrate delle conversioni di clic registrate se una pagina di reindirizzamento e l&#39;URL attività appartengono a proprietà diverse? &quot; |
...
|  | [Attributi di entità](/help/c-recommendations/c-products/entity-attributes.md) | Testo aggiornato nella nota sotto la `entity.id` variabile. |
| 1 maggio 2019 | [Attributi di entità](/help/c-recommendations/c-products/entity-attributes.md) | Sono state corrette le maiuscole nei seguenti nomi di variabili:<br>È stato modificato `pageURL` in `pageUrl`.<br>È stato modificato `thumbnailURL` in `thumbnailUrl`. |
| 30 aprile 2019 | [Opzioni del Compositore esperienza visivo](/help/c-experiences/c-visual-experience-composer/viztarget-options.md) | <ul><li>Aggiunta nuova sezione: &quot; Stili. &quot;</li><li>Aggiunta di un elenco di tabelle HTML 5 che possono essere nidificate.</li></ul> |
|  | [Tracciamento dei clic](/help/c-activities/r-success-metrics/click-tracking.md) | Aggiunte informazioni sulla funzionalità path path (Percorso DOM) alla sezione &quot;Considerazioni&quot;. |
|  | [Stato del feed e indicatori](/help/c-recommendations/c-products/feeds.md#section_5DDC2DECF70A42FDAFF2235E91371537) | Aggiornamento della tabella «Feed di feed». |
|  | [Utilizzare i contenuti della libreria](/help/c-experiences/c-manage-content/assets-working.md) | Sono state aggiunte informazioni sull&#39;eliminazione di cartelle e immagini dalla libreria Risorse. |
...
| Data | Argomento | Modifiche |
| --- | --- | --- |
| 29 aprile 2019 | [Autorizzazioni per gli utenti aziendali](/help/administrating-target/c-user-management/property-channel/property-channel.md#section_31D3450ADEAE4A29963A34F8E8C19FE0) | Sono state aggiunte le seguenti domande frequenti: &quot; Perché viene visualizzato un messaggio di errore per indicare che nessuna proprietà è associata a questa attività, anche se è stata assegnata una proprietà? &quot; |
| 24 aprile 2019 | [Aggiornamento da. js 1. x a. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#types) | Aggiunta nota alla sezione &quot;Tipi di attività&quot;. |
...
|  | [Controllo di qualità delle attività](/help/c-activities/c-activity-qa/activity-qa.md) | È stato corretto un errore minore. |
| 23 aprile 2019 | [Note sulla versione di Target (pre-rilascio)](/help/r-release-notes/target-release-notes.md) | Aggiornate le note sulla versione e la data in aprile 30 (prima aprile 29). |
| 22 aprile 2019 | [Accedere a Target da Adobe Experience Cloud](/help/c-intro/target-access-from-mac.md) | Aggiunta nuova sezione: &quot; Cambia la lingua predefinita per l&#39;interfaccia utente di Target. &quot; |
| 19 aprile 2019 | [Rapporto Segmenti automatizzati](/help/c-reports/c-personalization-insights-reports/automated-segments-report.md#section_740910A52FA646B4AC9452F98C2F5719) | Sono state aggiunte nuove domande frequenti: &quot; Esiste una logica per l&#39;ordine di visualizzazione degli attributi in una scheda segmenti? &quot; |
|  | [Feed](/help/c-recommendations/c-products/feeds.md#section_5DDC2DECF70A42FDAFF2235E91371537) | Nota importante che descrive la scadenza delle entità caricate. |
| 16 aprile 2019 | [Visualizzare i rapporti - Domande frequenti su A4T](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-viewing-reports.md) | Sono state aggiunte nuove domande frequenti: &quot; Posso cambiare la percentuale di allocazione del traffico in un&#39;attività che utilizza A 4 T dopo che l&#39;attività è stata attivata? &quot; |
| 15 aprile 2019 | [Provisioning iniziale - Domande frequenti su A4T](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-initial-provisioning.md) | Sono state aggiunte nuove domande frequenti: &quot; How can I configurup a multi-page A 4 T activity? &quot; |
|  | [Requisiti delle autorizzazioni utente](/help/c-integrating-target-with-mac/a4t/account-reqs.md) | Argomento aggiornato. |
|  | [Problemi noti e problemi risolti](/help/r-release-notes/known-issues-resolved-issues.md) | Sono stati spostati i problemi noti relativi ai gruppi di esclusione nella tabella dei problemi risolti. |
| 11 aprile 2019 | [adobe. target. getoffer (options) - at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Esempi di codice aggiornati. |
|  | [Estensione Adobe Target VEC Helper](/help/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/vec-helper-browser-extension.md) | Sono state aggiunte schermate. |
|  | [Allocazione automatica](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md) | Sono state aggiunte le seguenti domande frequenti: &quot; Posso rimuovere un&#39;esperienza insoddisfacente da un&#39;attività di allocazione automatica per velocizzare il processo di determinazione di un vincitore? &quot; |
| 10 aprile 2019 | [Prima dell’implementazione](/help/c-integrating-target-with-mac/a4t/before-implement.md) | Aggiornamenti minori alla sezione «Requisiti di implementazione» (requisiti riordinati). |
|  | [adobe. target. triggerview (viewname, options) - at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-triggerview-atjs-2.md) | Testo aggiornato per il parametro &quot;options &gt; page&quot;. |
| 8 aprile 2019 | [Variabilità dei dati previste tra Target e Analytics durante l’utilizzo e non utilizzo A4T](/help/c-integrating-target-with-mac/a4t/understanding-expected-data-variances.md) | È stata aggiornata [la varianza dei dati prevista quando si utilizza A 4 T](/help/c-integrating-target-with-mac/a4t/understanding-expected-data-variances.md#expected-using-a4t). |
|  | [Minimizzare i conteggi gonfiati per visite e visitatori in A4T](/help/c-integrating-target-with-mac/a4t/c-a4t-troubleshooting/minimizing-inflated-visit-and-visitor-counts-a4t.md) | Updated information about A 4 T and redirects under [What contributes to parziali data?](/help/c-integrating-target-with-mac/a4t/c-a4t-troubleshooting/minimizing-inflated-visit-and-visitor-counts-a4t.md#section_C9C906BEAA7D44DAB9D3C03932A2FEB8) |
|  | [Prima dell’implementazione](/help/c-integrating-target-with-mac/a4t/before-implement.md#section_A0D2EF18033D4C3997B08A6EBB34C17A) | Aggiornato i requisiti del mininum per utilizzare A 4 T con reindirizzamenti (all&#39;indirizzo. js versione 1.6.2). |
|  | [Offerte di reindirizzamento - Domande frequenti su A4T](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-redirect-offers.md#section_FA9384C2AA9D41EDBCE263FFFD1D9B58) | <ul><li>Aggiornato i requisiti del mininum per utilizzare A 4 T con reindirizzamenti (all&#39;indirizzo. js versione 1.6.2).</li><li>Sono state aggiunte informazioni che descrivono il conteggio delle metriche dei dati quando si verifica un hit Target, ma non si verifica alcun hit Analytics. </li> |
|  | [Limiti](/help/r-troubleshooting-target/target-limits.md#excludedid) | Sono state aggiunte informazioni sui limiti per il parametro `excludedIDs` mbox. |
|  | [Aggiornamento da. js 1. x a. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#response-tokens) | Aggiunta nuova sezione: Token di risposta. |
| 5 aprile 2019 | [Webinar di base di Adobe Target: Introduzione a Recommendations](/help/c-recommendations/recommendations.md#intro-to-recs) | Aggiunto collegamento alla registrazione webinar «Introduction to Recommendations». |
|  | [Bookmarklet di controllo qualità delle attività](/help/c-activities/c-activity-qa/activity-qa-bookmark.md) | Codice javascript aggiornato per il bookmarklet QA attività. |
|  | [Note sulla versione di Target (pre-rilascio)](/help/r-release-notes/target-release-notes.md) | Aggiornate le note preliminari sulla versione per le release di Target 19.4.1 e Target 19.4.2, entrambe pianificate per aprile 2019. |
| 4 aprile 2019 | [Note sulla versione di Target (pre-rilascio)](/help/r-release-notes/target-release-notes.md) | Sono state aggiunte note preliminari sulla versione per le release di Target 19.4.1 e Target 19.4.2, entrambe pianificate per aprile 2019. |
| 30 marzo 2019 | [Limiti](/help/r-troubleshooting-target/target-limits.md#excludedid) | Sono state aggiunte informazioni sui limiti per il parametro `excludedID` mbox. |
| 29 marzo 2019 | [Problemi noti e problemi risolti](/help/r-release-notes/known-issues-resolved-issues.md) | È stato aggiunto il seguente problema noto: &quot; Per i siti Web delle applicazioni singole (SPA), l&#39;annullamento del caricamento non consente di modificare le azioni nel pannello [!UICONTROL Modifiche] . &quot;<br>È stato spostato il seguente problema noto nella sezione Problemi risolti: &quot; La versione v 1 delle API Offer on Adobe I/O considera tutte le offerte create tramite Target per essere nell&#39;area di lavoro predefinita. &quot; |
| 28 marzo 2019 | [Compositore esperienza visivo (VEC)](/help/c-experiences/c-visual-experience-composer/visual-experience-composer.md) | Sono state aggiunte le seguenti nuove sezioni:<ul><li>[Annullare il caricamento di una pagina all&#39;interno dell&#39;aula virtuale.](/help/c-experiences/c-visual-experience-composer/visual-experience-composer.md#cancel-loading)</li><li>[Modificare una pagina durante il caricamento della pagina o dopo il caricamento della pagina](/help/c-experiences/c-visual-experience-composer/visual-experience-composer.md#loading).</li></ul> |
|  | [Opzioni Visual Experience Composer (Compositore esperienza visivo)](/help/c-experiences/c-visual-experience-composer/viztarget-options.md) | Nuova sezione: &quot;[Navigare tra gli elementi utilizzando il percorso DOM](/help/c-experiences/c-visual-experience-composer/viztarget-options.md#dom-path). &quot; |
|  | [Problemi noti e problemi risolti](/help/r-release-notes/known-issues-resolved-issues.md#cancel) | È stato aggiunto un problema noto relativo all&#39;annullamento del caricamento di una pagina all&#39;interno della VEC. |
...
| Data | Argomento | Modifiche |
| --- | --- | --- |
| 20 marzo 2019 | [Domande frequenti su at.js ](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-atjs-faq/target-atjs-faq.md) | Sono state aggiornate le seguenti domande frequenti: &quot;[Posso caricare la libreria Target in modo asincrono?](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-atjs-faq/target-atjs-faq.md#section_AB9A0CA30C5440C693413F1455841470)&quot; |
|  | [Sincronizzazione dei profili in tempo reale per mbox3rdPartyID](/help/c-target/c-visitor-profile/3rd-party-id.md) | Nota nella parte inferiore della pagina. |
|  | [Limitsattributi](/help/r-troubleshooting-target/target-limits.md)<br>[entità personalizzati](/help/c-recommendations/c-products/custom-entity-attributes.md#limits) | Sono state aggiunte informazioni sui limiti dell&#39;attributo personalizzato di entità. |
...
|  | [Creare nuovi criteri](/help/c-recommendations/c-algorithms/create-new-algorithm.md#custom) | Aggiunta di una nuova sezione che spiega come creare raggruppamenti basati su profilo per gli algoritmi di popolarità: &quot; Utilizza una chiave di raccomandazione personalizzata. &quot; |
...
|  | [Visualizzare i rapporti - Domande frequenti su A4T](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-viewing-reports.md) | Sono state aggiunte le seguenti domande frequenti: &quot; A 4 T support virtual report suites? &quot; |
| 18 marzo 2019 | [Note sulla versione di Target (prerelease)](/help/r-release-notes/target-release-notes.md) e [dettagli sulla versione. js](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) | Nuove informazioni sulle versioni 2.0.1 e 1.7.1 di at.js. |
|  | [Metodi per ottenere i dati in Target](/help/c-implementing-target/c-considerations-before-you-implement-target/c-methods-to-get-data-into-target/methods-to-get-data-into-target.md#section_92AB4820A5624C669D9A1F1B6220D4FA) e [attributi cliente](/help/c-target/c-visitor-profile/working-with-customer-attributes.md) | Aggiunto: Non potete inviare i seguenti caratteri in `mbox3rdPartyID`: segno più (+) e barra (/). |
| 15 marzo 2019 | [Prima dell’implementazione](/help/c-implementing-target/c-considerations-before-you-implement-target/considerations-before-you-implement-target.md) | Nota importante: Le modifiche a at. js o mbox. js non saranno supportate da Adobe Customer Care. |
| 14 marzo 2019 | [Note sulla versione di Target (pre-rilascio)](/help/r-release-notes/target-release-notes.md) | È stata modificata la data di Target Standard/Premium 19.3.1 rilasciata al 29 marzo 2019. |
...
|  | [Attributi del profilo](/help/c-target/c-visitor-profile/profile-parameters.md) | Aggiunta nuova sezione: &quot; Riferimento javascript per parametri di profilo di script. &quot; |
|  | [Funzioni di at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/cmp-atjs-functions.md) | Pagina ristrutturata e creazione di nuove pagine per ogni funzione at. js per semplificare l&#39;accesso alle informazioni. |
|  | [Funzionamento di at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-how-atjs-works/how-atjs-works.md) | Aggiunto paragrafo introduttivo per spiegare un&#39;implementazione lato client. |
|  | [Domande frequenti sui consigli](/help/c-recommendations/c-recommendations-faq/recommendations-faq.md) | Sono state aggiunte le seguenti domande frequenti: &quot; È possibile escludere in modo dinamico un&#39;entità? &quot; |
| 12 marzo 2019 | [Aggiornamento da. js 1. x a at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) e [Debug at. js mediante il debugger di Adobe Experience Cloud](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-debugging-atjs/target-debugging-atjs.md) | Il debugger è ora un&#39;integrazione supportata con at. js 2. x. |
| 11 marzo 2019 | [Note sulla versione di Target (corrente)](/help/r-release-notes/release-notes.md),<br>[note sulla versione di Target (prerelease)](/help/r-release-notes/target-release-notes.md)e modifiche <br>[di crittografia TLS (Transport Layer Security)](/help/c-implementing-target/c-considerations-before-you-implement-target/tls-transport-layer-security-encryption.md) | Testo aggiornato per indicare che le modifiche TLS verranno apportate il **1 aprile 2019**. |
|  | [adobe. target. getoffer](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Aggiunta la sezione seguente: &quot; Recuperate ed eseguite il rendering dei dati da più mbox tramite getoffers () e applyoffers (). &quot; |
| 6 marzo 2019 | [Aggiornamento da. js 1. x a. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) | È stata aggiunta alla riga_ proprietà i parametri «at. js 1. x» alla tabella di mappatura payload. js 2. x. |
|  | [Implementazione di un&#39;applicazione a pagina singola](/help/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/target-atjs-single-page-application.md) | Aggiunta nuova sezione: &quot; Utilizzate triggerview per garantire che A 4 T funzioni correttamente con at. js 2. x e spas. &quot; |
| 4 marzo 2019 | [Documentazione Classic Classic](/help/c-recommendations/recommendations-classic-documentaton.md) | Nuovo argomento. |
|  | [Confronto tra Recommendations Classic e le attività Consigli di Target Premium](/help/c-recommendations/c-recommendations-faq/recommendations-classic-versus-recommendations-activities-target-premium.md) | Aggiunte informazioni su Recommendations come offerta. |
| 28 febbraio 2019 | [Attività](/help/c-activities/activities.md) | Aggiornati testo e immagini. |
|  | [Introduzione a Target](/help/c-intro/intro.md) | Aggiunta «Recommendations come offerta» in «Target Premium». |
|  | [Concetti chiave di Target](/help/c-intro/target-key-concepts.md) | Tabella &quot;Tipi di attività&quot; aggiornata. |
...
| 25 febbraio 2019 | [Note sulla versione di Target (corrente)](/help/r-release-notes/release-notes.md), <br>[note sulla versione di Target (prerelease)](/help/r-release-notes/target-release-notes.md)e modifiche <br>[di crittografia TLS (Transport Layer Security)](/help/c-implementing-target/c-considerations-before-you-implement-target/tls-transport-layer-security-encryption.md) | Sono state aggiornate le informazioni seguenti:<br>Il 20 febbraio 2019 l&#39;infrastruttura Adobe Target è stata aggiornata nelle aree EMEA, Japan e APAC per non raccogliere più dati dagli utenti finali con dispositivi meno recenti o browser Web che non supportano TLS 1.1 o versione successiva. Lo stesso aggiornamento è pianificato per l&#39;America del Nord il **4 marzo 2019**. La migrazione a TLS 1.2 offre una maggiore protezione. È importante che esamini a fondo le specifiche e pianifichi le modifiche per una transizione senza problemi. |
|  | [Aggiornamento da. js 1. x a. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#payload-mapping) | Nuova sezione: &quot; at. js 1. x per la mappatura payload. js 2. x. &quot; |
|  | [Risoluzione dei problemi relativi al Compositore esperienza avanzato](/help/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/troubleshooting-issues-related-to-the-enhanced-experience-composer-eec.md) | È stata aggiunta la colonna &quot;Nomehost&quot; agli indirizzi IP della whitelist. |
| 22 febbraio 2019 | [Configurare le autorizzazioni Enterprise](/help/administrating-target/c-user-management/property-channel/properties-overview.md) | Aggiunta della sezione «Ottieni ID Workspace». |
...
|  | [Aggiornamento da. js 1. x a. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) | Nuovo argomento e nuovo video di formazione. |
|  | [Funzioni di at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/cmp-atjs-functions.md) | Argomento aggiornato per riflettere le modifiche con l&#39;introduzione di at. js 2. x.<br>Sono disponibili tre nuove fusi per at. js 2. x.<ul><li>adobe.target.getOffers(options)</li><li>adobe.target.applyOffers(options)</li><li>adobe.target.triggerView (viewName, options)</li></ul> |
|  | [Funzionamento di at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-how-atjs-works/how-atjs-works.md) | Argomento aggiornato per riflettere le modifiche con l&#39;introduzione di at. js 2. x e aggiunta di video di formazione. |
|  | [Gestione at.js della visualizzazione momentanea di altri contenuti](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-how-atjs-works/manage-flicker-with-atjs.md) | Argomento aggiornato per riflettere le modifiche con l&#39;introduzione di at. js 2. x. |
|  | [Domande frequenti su at.js ](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-atjs-faq/target-atjs-faq.md) | Argomento aggiornato per riflettere le modifiche con l&#39;introduzione di at. js 2. x. |
|  | [Eseguire il debug di at.js utilizzando il debugger di Adobe Experience Cloud](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-debugging-atjs/target-debugging-atjs.md) | Aggiunta nota per spiegare che le funzioni di richiesta di debugger di Adobe Experience Cloud e Traccia mbox non sono ancora supportate per at. js 2. x. |
...
|  | [Privacy e Regolamento generale sulla protezione dei dati](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/cmp-privacy-and-general-data-protection-regulation.md) (RGPD) | Modifiche minori e informazioni sulla funzionalità di consenso e su. js 1.7.0 e at. js 2. x. |
...
| Data | Argomento | Modifiche |
| --- | --- | --- |
| 2 febbraio 2019 | [Note sulla versione di Target](/help/r-release-notes/target-release-notes.md) (pre-rilascio) | Aggiornate note di pre-rilascio relative a [!DNL Target] versione 19.2.1 (19 febbraio 2019). |
...
|  | [Note sulla versione di Target (corrente)](/help/r-release-notes/release-notes.md)<br>[Note sulla versione di Target (pre-rilascio)](/help/r-release-notes/target-release-notes.md)<br>[Browser supportati](/help/c-implementing-target/c-considerations-before-you-implement-target/supported-browsers.md) | Aggiunte informazioni sul supporto di Target e Adobe Marketing Cloud per Microsoft Internet Explorer 11 non più disponibile a partire da marzo 2019. |
|  | [Note sulla versione di Target (pre-rilascio)](/help/r-release-notes/target-release-notes.md) | Aggiunte informazioni per le versioni 19.1.1 di Target e 1.6.4 di at.js. |
...
|  | [Note sulla versione di Target (pre-rilascio)](../r-release-notes/target-release-notes.md#reference_4A966062C61048D1A81412E2DDB16E34) | Aggiunte informazioni sulle funzionalità nella versione di Target 18.11.1. |
...
<table id="table_0348AA29207D48A4BDFFA187F4F845B7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Aggiunta la sezione “Consenso Adobe Target e Adobe Launch”. </p> <p>Le seguenti domande frequenti sono state aggiornate: </p> <p> 
...
<table id="table_F09AC99B587A4D6390B1F8AE54F5DC47"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <a href="../c-implementing-target/c-considerations-before-you-implement-target/c-privacy/cmp-privacy-and-general-data-protection-regulation.md#concept_41F88DE95D2943178BEC382736B5C038" format="dita" scope="local"> Domande frequenti sul regolamento generale sulla protezione dei dati </a> </p> </td> 
