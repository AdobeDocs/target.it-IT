...
| 27 ottobre | [Lato server: implementare Target](/help/c-implementing-target/c-api-and-sdk-overview/api-and-sdk-overview.md) | È stato aggiunto un collegamento al nuovo portale *[SDK](https://adobetarget-sdks.gitbook.io/docs/)* Adobe Target. |
...
| Data | Argomento | Modifiche |
| --- | --- | --- |
| 26 ottobre | [Panoramica sulla sicurezza di Target](/help/c-implementing-target/c-considerations-before-you-implement-target/target-security-overview.md) | Aggiornato il white paper *Adobe Target Security Overview* (Panoramica sulla sicurezza). |
...
|  | [targetGlobalSettings()](/help/c-implementing-target/c-implementing-target-for-client-side-web/targetgobalsettings.md) | Aggiunto testo che indica che se utilizzate `serverState` e utilizzate `<script>` i tag nel contenuto restituito, assicuratevi che il contenuto HTML utilizzi `<\/script>` invece di `</script>`. |
...
| 3 agosto | [Metriche di successo](/help/c-activities/r-success-metrics/success-metrics.md) | È stata aggiunta una nota che chiarisce il significato delle opzioni [!UICONTROL Incremento conteggio] per i visitatori rispetto alle visite. |
...
|  | [Attributi del cliente](/help/c-target/c-visitor-profile/working-with-customer-attributes.md) | Updated following paragraph:<br>[!DNL Adobe] does not guarantee that 100% of customer attribute (visitor profile) data from CRM databases will be onboarded to the [!DNL Experience Cloud] and, thus, be available for use for targeting in [!DNL Target]. Nella nostra progettazione attuale, esiste la possibilità che una piccola percentuale di dati (fino allo 0,1% dei batch di produzione di grandi dimensioni) potrebbe non essere caricata. |
...
|  | [Panoramica della documentazione di Target](/help/r-release-notes/target-documentation.md) | Nuovo argomento con informazioni dettagliate sulle diverse fonti di [!DNL Target] documentazione. |
